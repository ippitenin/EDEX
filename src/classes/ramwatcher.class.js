class RAMwatcher {
    constructor(parentId) {
        if (!parentId) throw new Error("RAMwatcher: missing parentId");
    ...
    updateInfo() {
        ...
        window.si.mem().then(data => {
            if (!data.total || !isFinite(data.free) || !isFinite(data.used)) throw new Error("RAMwatcher: unusable memory values");
