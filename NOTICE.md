...
This product is a derivative work of **eDEX-UI**.

```
eDEX-UI
Copyright © 2017–2021 Gabriel "Squared" SAILLARD <gabriel@saillard.dev>
https://github.com/GitSquared/edex-ui

EDEX (this fork)
Copyright © 2026 Ilya Pitenin
https://github.com/ippitenin/EDEX
```

Both the original work and this fork are licensed under the GNU General Public License,
...
This project bundles and depends on third-party open-source software, each under its own
